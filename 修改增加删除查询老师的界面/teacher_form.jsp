...
<head>
	...
	<link rel="stylesheet" href="${ctx }/css/teacher_form.css" type="text/css" />
...
$(document).ready(function(){
	//验证工号
	 ...
	 $("input[name='id']").blur(function(){
		...
		var pattern = /\D/ig;
		if(idvalue == ""){
			$(this).css({"background-color":"#ffdee2",
						...
						<section class="scrollable padder">
							<div class="location">
          			 		...
          			 		<c:if test="${action=='edit' }">
								<form action="${ctx }/Teachermanage/edit?pageNum = ${pageNum}" name="form_uploadImg" method="post" enctype="multipart/form-data">
							</c:if> 
							<c:if test="${action!='edit' }">
								<form action="${ctx }/Teachermanage/add" name="form_uploadImg" method="post" enctype="multipart/form-data">
          			 				...
          			 				<div class="everyone">
          			 					...
          			 					<span id="gonghaospan" class="red1">工号不能为空！</span>
          			 				</div>
          			 				<div class="everyone">
          			 					<span class="red">&nbsp;&nbsp;&nbsp;&nbsp;*</span>
          			 					<span>姓名：</span>
          			 					<input type="text" value="${teac.name }" name="name"/>
          			 					<span id="xingming" class="red1">姓名不能为空！</span>
          			 				</div>
          			 				<div class="everyone">
          			 					<span class="red">&nbsp;&nbsp;&nbsp;&nbsp;*</span>
          			 					<span>邮箱：</span>
          			 					<input type="text" value="${teac.email }" name="email"/>
          			 					<span id="youxiang" class="red1">邮箱不能为空！</span>
          			 				</div>
          			 				<div class="everyone">
          			 					<span class="red">&nbsp;&nbsp;*</span>
          			 					<span>入职日期：</span>
          			 					<input type="date" value="${teac.hiredate }" name="hi"/>
          			 					<span class="red1" id="ruzhiriqi">入职时间不能为空！</span>
          			 				</div>
          			 				<div class="everyone">
          			 					<span class="red">&nbsp;&nbsp;&nbsp;&nbsp;*</span>
          			 					<span>电话：</span>
          			 					<input type="text" value="${teac.phone }" name="phone"/>
          			 					<span class="red1" id="dianhua">手机号码不能为空！</span>
          			 				</div>
          			 				<div class="everyone">
          			 					<span>&nbsp;&nbsp;&nbsp;家庭住址：</span>
          			 					<input type="text" value="${teac.address }" name="address"/>
          			 				</div>
          			 				<div class="everyone">
          			 					<span>&nbsp;统一默认密码：</span>
          			 					<input type="text" value="12345678" name="password"/>
          			 				</div>
          	<c:if test="${action=='edit' }">
				<div>
