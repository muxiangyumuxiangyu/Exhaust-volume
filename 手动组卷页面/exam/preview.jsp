		...
		*/
        ...
        $(".replace").live("click",function()
        {
            ...
            ({
                ...
                url: "${ctx}/jiaoshi/exam/changeQuestion",
                dataType: "json",
                async: true,
...
function whether_change_title(){
	$.ajax({
		type: "POST",
		url: "${ctx}/jiaoshi/exam/saveTitle",
		data: "",
...
function edit_paper_title(title,title2){
    ...
    var AjaxUrl = "${ctx}/jiaoshi/exam/changeTitle";
    var examId=${exam.id};
    $.ajax({
        type: "POST",
...
<body>
	...
	<div><div id="submit1"><input id="submit2" type="button" value="保存试卷" onclick="window.location.href='${ctx}/jiaoshi/exam/listExam'"></div></div>
</body>
</html> 