...
INSERT INTO `question` VALUES ('1', '编译Java  Application 源程序文件将产生相应的字节码文件，这些字节码文件的扩展名为(  )', '1', '1', '1', null, null, 'A. java', 'B.C++', 'C. c', 'D. JS');
...
INSERT INTO `question` VALUES ('5', '运行时异常与一般异常有何异同？', '1', '5', '1', null, null, null, null, null, null);
INSERT INTO `question` VALUES ('6', '说出ArrayList,Vector, LinkedList的存储性能和特性', '1', '6', '1', null, null, null, null, null, null);
INSERT INTO `question` VALUES ('7', 'final, finally, finalize的区别。', '1', '7', '1', null, null, null, null, null, null);
INSERT INTO `question` VALUES ('8', '（1）-23+（-37）-（-12）\r\n+45\r\n（1）-23+（-37）-（-12）\r\n+45\r\n；', '1', '8', '1', null, null, null, null, null, null);
INSERT INTO `question` VALUES ('9', '证明:在结点数多于1的哈夫曼树中不存在度为1的结点', '1', '9', '1', null, null, null, null, null, null);
INSERT INTO `question` VALUES ('10', '写一个函数，例如：给你的 a b c 则输出 abc  acb  bac  bca  cab  cba', '1', '10', '1', null, null, null, null, null, null);
